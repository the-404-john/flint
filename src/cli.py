...
class CLI:
    ...
    def write_on_stdout(self, msg: str) -> None:
        if CLIOption.silent not in self.options:
    ...
    def cmd_run(self) -> None:
        ...
        if CLIOption.help in self.options:
            return self.write_on_stdout(RUN_HELP_MESSAGE)
        ...
        step_limit  = self.options.get(CLIOption.step_limit)  or 0
        cycle_limit = self.options.get(CLIOption.cycle_limit) or 0
    ...
    def cmd_check(self) -> None:
        ...
        if CLIOption.help in self.options:
            return self.write_on_stdout(CHECK_HELP_MESSAGE)
    ...
    def cmd_watch(self) -> None:
        ...
        if CLIOption.help in self.options:
            return self.write_on_stdout(WATCH_HELP_MESSAGE)
    ...
    def cmd_format(self) -> None:
        ...
        if CLIOption.help in self.options:
            return self.write_on_stdout(FORMAT_HELP_MESSAGE)
    ...
    def cmd_example(self) -> None:
        ...
        self.write_on_stdout(EXAMPLE_MESSAGE)
    ...
    def cmd_help(self) -> None:
        ...
        self.write_on_stdout(HELP_MESSAGE)
